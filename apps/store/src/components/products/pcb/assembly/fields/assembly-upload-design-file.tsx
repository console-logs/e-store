...
import { UploadAssemblyDesignFileButton } from "@/components/products/pcb/assembly/assembly-design-file-upload-button";
import { Input } from "@shared/components/ui/input";
import { Label } from "@shared/components/ui/label";
import { useState } from "react";

export function AssemblyUploadDesignFile() {
	...
	return (
		<div>
			...
			<div className="flex gap-x-2">
				...
				/>
				<UploadAssemblyDesignFileButton file={file} />
			</div>
		</div>
	);
}
