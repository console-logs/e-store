...
export const RigidPcbFabSpecsTypeSchema = z.object({
	...
	goldThickness: z.union([z.literal('1 U"'), z.literal('2 U"')]),
	edgeRails: z.union([z.literal("No"), z.literal("On 2 Sides"), z.literal("On 4 Sides")]),
	edgeRailSize: z.union([z.literal("5mm"), z.literal("7mm"), z.literal("10mm")]),
	panelSizeX: z.number(),
	panelSizeY: z.number(),
	outerCuWeight: z.union([z.literal("1 oz"), z.literal("2 oz")]),
	copperStructure: z.literal("Direct Heatsink"),
	thermalConductivity: z.union([z.literal(1), z.literal(380)]),
	breakDownVoltage: z.literal(3000),
	innerCuWeight: z.union([z.literal("0.5 oz"), z.literal("1 oz"), z.literal("2 oz")]),
	impedenceControl: z.union([z.literal("Yes"), z.literal("No")]),
	viaCovering: z.union([
		z.literal("Tented"),
		z.literal("Untented"),
		z.literal("Plugged"),
	...
	minViaHoleSizeAndDiameter: z.union([
		z.literal("0.3mm/(0.4/0.45mm)"),
		z.literal("0.25mm/(0.35/0.40mm)"),
		z.literal("0.2mm/(0.3/0.35mm)"),
		z.literal("0.15mm/(0.25/0.3mm)"),
	]),
	boardOutlineTolerance: z.union([z.literal("\u00B10.2mm(Regular)"), z.literal("\u00B10.1mm(Precision)")]),
	viaHoles: z.number(),
	castellatedHoles: z.union([z.literal("Yes"), z.literal("No")]),
	castellatedHolesEdges: z.union([z.literal(1), z.literal(2), z.literal(3), z.literal(4)]),
	chamferedGoldFingers: z.union([z.literal("Yes"), z.literal("No")]),
	leadTime: z.union([
...
export const FlexPcbFabSpecsTypeSchema = z.object({
	...
	boardOutlineTolerance: z.union([z.literal("\u00B10.1mm"), z.literal("\u00B10.05mm")]),
	viaHoles: z.number(),
	leadTime: z.union([
		z.literal("3 Working days"),
		z.literal("5 Working days"),
	...
	polyimideThickness: z.union([z.literal(0.1), z.literal(0.15), z.literal(0.2), z.literal(0.225), z.literal(0.25)]),
	fr4Thickness: z.union([z.literal(0.1), z.literal(0.2)]),
	stainlessSteelThickness: z.union([z.literal(0.1), z.literal(0.2), z.literal(0.3)]),
	threeMTapeThickness: z.union([z.literal("3M468 (0.13mm)"), z.literal("3M9077 (HT, 0.05mm)")]),
