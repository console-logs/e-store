		...
		<main className="grid min-h-full place-items-center px-10 py-24 sm:py-32 lg:px-10">
			<div>
				...
				<p className="mt-6 text-base leading-7 text-muted-foreground">
					...
					We&apos;ll let you know once they are ready! In the meanwhile if you are interested to find out on
					what features we are planning to realse in the coming weeks, head over to our roadmaps page and take
					a look.
				</p>
