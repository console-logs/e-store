...
export default function BoardOutlineTolerance() {
  ...
  const boardOutlineToleranceOptions = useSelector(
    (state: ReduxState) => state.rigidPcb.boardOutlineToleranceOptions,
  );
  const boardOutlineTolerance = useSelector(
    (state: ReduxState) => state.rigidPcb.boardOutlineTolerance,
  );
