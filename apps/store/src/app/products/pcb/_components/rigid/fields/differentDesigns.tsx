...
export default function DifferentDesignsInPanel() {
  ...
  const differentDesignsInPanelOptions = useSelector(
    (state: ReduxState) => state.rigidPcb.differentDesignsInPanelOptions,
  );
  const differentDesignsInPanel = useSelector(
    (state: ReduxState) => state.rigidPcb.differentDesignsInPanel,
  );
