...
export default function GoldThickness() {
  ...
  const goldThicknessOptions = useSelector(
    (state: ReduxState) => state.rigidPcb.goldThicknessOptions,
  );
  const goldThickness = useSelector(
    (state: ReduxState) => state.rigidPcb.goldThickness,
  );
