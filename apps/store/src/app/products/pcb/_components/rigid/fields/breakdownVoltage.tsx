...
export default function BreakdownVoltage() {
  ...
  const breakdownVoltageOptions = useSelector(
    (state: ReduxState) => state.rigidPcb.breakDownVoltageOptions,
  );
  const breakdownVoltage = useSelector(
    (state: ReduxState) => state.rigidPcb.breakDownVoltage,
  );
