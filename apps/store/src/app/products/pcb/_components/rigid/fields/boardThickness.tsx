...
export default function BoardThickness() {
  ...
  const boardThicknessOptions = useSelector(
    (state: ReduxState) => state.rigidPcb.boardThicknessOptions,
  );
  const boardThickness = useSelector(
    (state: ReduxState) => state.rigidPcb.boardThickness,
  );
