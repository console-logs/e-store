...
export default function ChamferedGoldFingers() {
  ...
  const chamferedGoldFingersOptions = useSelector(
    (state: ReduxState) => state.rigidPcb.chamferedGoldFingersOptions,
  );
  const chamferedGoldFinger = useSelector(
    (state: ReduxState) => state.rigidPcb.chamferedGoldFingers,
  );
