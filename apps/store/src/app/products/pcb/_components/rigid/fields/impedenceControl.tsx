...
import ImpedenceControlTip from "@/app/products/pcb/_components/rigid/tips/impedenceControlTip";
...
export default function ImpedenceControl() {
  ...
  const impedenceControlOptions = useSelector(
    (state: ReduxState) => state.rigidPcb.impedenceControlOptions,
  );
  const impedenceControl = useSelector(
    (state: ReduxState) => state.rigidPcb.impedenceControl,
  );
