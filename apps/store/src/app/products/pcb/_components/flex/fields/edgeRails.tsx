	...
	return (
		<div hidden={designFormat === "Single PCB" ? true : designFormat === "Panel by Customer" ? true : false}>
			<Label>
				...
				<HelpPopover>
					<p>
						Edge rails are added for increasing component-to-board-edge clearances. Edge rails that are
						added for increasing component-to-board-edge clearances are to be at least 5mm.
					</p>
				</HelpPopover>
			</Label>
			<Listbox
