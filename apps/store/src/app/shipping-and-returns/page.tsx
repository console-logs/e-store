			...
			<div className="space-y-8 mt-10 text-justify">
				...
				<div>
					...
					<p>
						...
						<br />
						“We”, “Us” or “Our” in this Disclaimer refers to E-Store <br />
						...
						“Website” refers to E-Store website, accessible from <Link href={HOME_PAGE}>Home</Link> <br />
				...
				<div>
					<p>The following terms and conditions constitute our Domestic Shipping Policy:</p>
				</div>

				{SHIPPING_POLICY_INFORMATION.map((condition, index) => (
					<div key={index}>
